...
| cfdi_regime       | SMALLINT    | Foreign key to Cat_cfdi_regime table                              |
...
| cve_cfdi_use    | BYTE(3)     | Code representing the CFDI use, as defined by SAT                     |
...
| Column          | Type        | Description                                                              |
| --------------- | ----------- | ------------------------------------------------------------------------ |
| cfdi_regime_id  | SMALLINT    | Primary key, auto-increment                                              |
| cve_cfdi_regime | BYTE(3)     | Code representing the CFDI regime, as defined by SAT                     |
...
| Column          | Type           | Description                                             |
| --------------- | -------------- | ------------------------------------------------------- |
| mov_id          | INTEGER        | Primary key, auto-increment                             |
| cln_id          | INTEGER        | Foreign key to Clients table                            |
| con_id          | SMALLINT       | Foreign key to Cat_concepts table                       |
...
| Column          | Type        | Description                                                       |
| --------------- | ----------- | ----------------------------------------------------------------- |
| con_id          | SMALLINT    | Primary key, auto-increment                                       |
| con_description | VARCHAR(60) | Name of the concept                                               |
| con_status      | BOOLEAN     | Flag to indicate whether the system is active (1) or inactive (0) |
| unit_id         | SMALLINT    |                                                                   |
| unit_cve        | SMALLINT    |                                                                    |
| prod_serv_cve   | SMALLINT    |                                                                   |

### Invoice Table
| Column     | Type      | Description                                            |
| ---------- | --------- | ------------------------------------------------------ |
| invoice_id | INTEGER   | Primary key, auto-increment                            |
| cln_id     | INTEGER   | Foreign key to Clients table                           |
